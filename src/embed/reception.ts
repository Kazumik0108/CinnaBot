...
const rules: reactMessage = {
    ...
    embed: new MessageEmbed()
        ...
        .setColor('#059ecd')
        .setDescription('Please familiarize yourself with our rules below. To gain access to the rest of the server, react to the message with <:RinIcon:725037351486881824> to become a <@&747124541259776030>.')
        .addFields([
            {
                name: '1. General Decency',
                value: 'Please be respectful of others. Harrassment and insults will not be tolerated and will be met with warnings, mutes, or bans as necessary. Please ping our <@&725016505749864570> if there are any issues in the chat.',
            },
            {
                name: '2. On NSFW/18+ content',
                value: 'Yuru Camp is not a NSFW series and not all of our members are over 18. Keep the channels SFW and refrain from sending such images, text, and links.\n\n' +
                    'At minimum, spoiler tag any messages with questionable content.',
            },
            {
                name: '3. Spamming',
                value: 'Please do not use the server to spam whatever you want. Some channels under the `Spamming` category exist for this purpose.',
            },
            {
                name: '4. Spoilers',
                value: 'Keep spoilers for anime, manga, novels, etc. out of <#725009172357316698> and the voice channels. Not everybody reads or watches at the same pace. Ideally, spoiler-tag the content and mention the series so others are aware of what is being spoilered. This goes especially for seasonals.\n\n' +
...
const accessRoles: reactMessage = {
    ...
    embed: new MessageEmbed()
        ...
        .addFields([
            {
                name: 'Key',
                value: '<:RinPinged:745677254696370266> : <@&796073053662216242> Access to <@!159985870458322944>\'s dumping grounds.\n' +
        ...
        .addFields([
            {
                ...
                value: '- If you do not have the role, reacting with the emote will give you the role.\n' +
                    '- If you already have the role, reacting with the emote wil remove the role.',
            },
            {
                name: 'Key',
                value: '<:Blue:803862924950110210> : <@&779064341407858698>\n' +
